...
import it.unibo.psm.ricettasi.data.repository.RecipeRepositoryImpl
...
val repositoryModule = module {
    ...
    single<PantryRepository> { PantryRepositoryImpl(get(), get(), get()) }
    single<IngredientRepository> { IngredientRepositoryImpl(get(), get(), get()) }
    single<RecipeRepository> { RecipeRepositoryImpl(get(), get(), get(), get(), get(), get(), get(), get(), get()) }
}